/*
  ...
  - You are about to drop the `Voting_Log` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE `Voting_Log` DROP FOREIGN KEY `Voting_Log_star_id_fkey`;

-- DropForeignKey
ALTER TABLE `Voting_Log` DROP FOREIGN KEY `Voting_Log_user_id_fkey`;

-- DropForeignKey
ALTER TABLE `Voting_Log` DROP FOREIGN KEY `Voting_Log_vote_id_fkey`;
